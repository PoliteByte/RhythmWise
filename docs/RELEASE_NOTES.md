...
A small fix-up release. The calendar no longer gets squashed when your phone turns sideways, and RhythmWise is updated to run against the latest Android release so it keeps getting updates.
